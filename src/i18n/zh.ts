...
export const zh = {
  ...
  game: {
    ...
    eyebrow: "交互式宇宙探索游戏",
    title: "宇宙迷宫",
    subtitle: "驾驶飞船，探险太阳系的每一个角落",
    desc: "你将成为一名宇宙探险者，驾驶飞船并答出每颗行星的问题。全部探索完成后，将获得“宇宙探索者”徽章。",
    score: "分数",
    progress: "进度",
    restart: "重新挑战",
    finished: "探索完成",
    finishedDesc: "恭喜！你已经探索了所有行星。",
    finalScore: "最终得分",
    badge: "获得徽章",
    chooseAnswer: "选择答案",
    correct: "答对了！",
    ...
    warping: "超光速跳迁中 ·",
    targetPlanet: "目标行星",
    controlHint: "WASD / 方向键 驾驶 · 鼠标拖动视角",
    speed: "速度",
    distance: "距太阳",
    exploration: "探索度",
    mainQuests: "主线任务",
    ...
    tunnelProgress: "穿越进度",
    tunnelHit: "撞击陨石 · 护盾 -15",
    tunnelPickup: "回收能量球 · 燃料 +8",
    tunnelComplete: "成功穿越! 准备进入行星引力范围...",
    landingTitle: "行星降落挑战",
    landingDesc: "行星大气层危险重重, 需要操控飞船闪避行星表面障碍完成降落。",
    landingHint: "点击障碍物或 WASD 闪避 · 漏掉一个扣护盾 · 击毁加分",
    landingProgress: "降落进度",
    landingHit: "撞击障碍 · 护盾受损",
    landingDestroy: "成功击毁障碍 +30",
    landingComplete: "成功着陆! 开始寻找线索...",
    landingDangerSand: "沙尘暴来袭! 飞船正在被强风抢扣!",
    landingDangerLava: "火山喷发! 岩浆与碎石从天而降!",
    landingDangerStorm: "巨型风暴! 闪电与狂风捷巻一切!",
    landingDangerIce: "极寒冰晶! 密集冰锥高速坠落!",
    landingDangerGas: "高压气旋! 躲开漩涡中心!",
    clueTitle: "寻找行星线索",
    clueDesc: "着陆后请移动飞船收集 3 个发光线索点, 激活后即可开启本次任务。",
    clueHint: "方向键 驾驶 · 接近发光点即可自动收集",
    clueProgress: "线索收集",
    cluePickup: "获得线索 +1",
    clueComplete: "线索已收集完毕! 准备开启任务...",

    eventFlare: "太阳耀斑警告 · 远离太阳!",
    eventMeteors: "陨石雨来袭 · 启动护盾!",
    eventOxygen: "氧气告急 · 寻找补给",
    shields: "护盾",
    oxygen: "氧气",
    asteroidZone: "小行星带",
    kuiperZone: "柯伊伯带",
    ...
    safeZone: "已脱离危险区",
    perfectEnding: "完美通关",
    perfectDesc: "你已探遍太阳系 + 完成所有支线。获得「宇宙探索大师」徽章。",
    restartHint: "重新挑战",
    controls: "驾驶控制",
    forward: "前进",
    backward: "后退",
    ...
    questions: [
      // 水星
      { planet: "mercury", q: "水星的一太阳日约多长？", options: ["176 地球日", "88 地球日", "365 地球日", "58 地球日"], a: 1, fact: "水星是太阳系中轨道周期最短的行星，只需 88 天。" },
      // 金星
      { planet: "venus", q: "以下哪个描述不适用于金星？", options: ["最热的行星", "反向自转", "补太阳轨道", "有厚厚的二氧化碳大气"], a: 2, fact: "金星是最热的行星，自转方向与其他行星相反，且被厚厚二氧化碳云层覆盖。" },
      // 地球
      { planet: "earth", q: "地球大气中氧气的份额约为？", options: ["21%", "78%", "1%", "58%"], a: 0, fact: "地球大气中氮气 (N₂) 约 78%，氧气 (O₂) 约 21%。这个氧气份额是使生命成为可能的关键。" },
      // 火星
      { planet: "mars", q: "火星的“奥林匹斯山”是什么？", options: ["一座火山", "太阳系最高的山", "一个载人飞船遗址", "一条干坟的河流"], a: 1, fact: "奥林匹斯山高达 22 公里，是太阳系中最高的山脉，是三倊火山的三倍。" },
      // 木星
      { planet: "jupiter", q: "木星的“大红斗”是什么？", options: ["一颗卫星", "一场永久的风暴", "一个超级火山", "一颗超新星"], a: 1, fact: "大红斗是一场已持续数百年的反气旋，直径比地球还大。" },
      // 土星
      { planet: "saturn", q: "土星的环主要由什么组成？", options: ["冰与岩石碎片", "气体与尘埃", "金属与石头", "河流与沙漠"], a: 1, fact: "土星环由数以亿计的冰、岩石碎片与尘埃组成，包含从微米到数百米的颗粒。" },
      // 天王星
      { planet: "uranus", q: "天王星的一个独特之处是？", options: ["最热的行星", "以何角度倾斜自转", "有生命", "没有太阳系大气"], a: 1, fact: "天王星的自转轴与轨道面接近 98°，以“蹄与”方式绕太阳运动，是唯一一颗“躺着”的行星。" },
      // 海王星
      { planet: "neptune", q: "海王星上的“大黑斗”是什么？", options: ["一个火山口", "一场风暴反气旋", "一块深色大陆", "一颗黑色卫星"], a: 1, fact: "大黑斗是一个反气旋风暴，风速超过 2000 公里/小时，是太阳系中最快的风。" }
    ]
  },
  // Stories
  stories: {
